...
export class QemuVM extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmoxve:proxmox/qemuVM:QemuVM';
    ...
    public readonly disks!: pulumi.Output<outputs.proxmox.QemuVMDisk[] | undefined>;
    ...
    public readonly hostpcis!: pulumi.Output<outputs.proxmox.QemuVMHostpci[] | undefined>;
    ...
    public readonly ipconfig10!: pulumi.Output<string | undefined>;
    public readonly ipconfig11!: pulumi.Output<string | undefined>;
    public readonly ipconfig12!: pulumi.Output<string | undefined>;
    public readonly ipconfig13!: pulumi.Output<string | undefined>;
    public readonly ipconfig14!: pulumi.Output<string | undefined>;
    public readonly ipconfig15!: pulumi.Output<string | undefined>;
    ...
    public readonly ipconfig6!: pulumi.Output<string | undefined>;
    public readonly ipconfig7!: pulumi.Output<string | undefined>;
    public readonly ipconfig8!: pulumi.Output<string | undefined>;
    public readonly ipconfig9!: pulumi.Output<string | undefined>;
    ...
    public readonly networks!: pulumi.Output<outputs.proxmox.QemuVMNetwork[] | undefined>;
    /**
    ...
    public readonly pxe!: pulumi.Output<boolean | undefined>;
    ...
    public readonly serials!: pulumi.Output<outputs.proxmox.QemuVMSerial[] | undefined>;
     ...
     */
    public /*out*/ readonly unusedDisks!: pulumi.Output<outputs.proxmox.QemuVMUnusedDisk[]>;
    public readonly usbs!: pulumi.Output<outputs.proxmox.QemuVMUsb[] | undefined>;
    public readonly vcpus!: pulumi.Output<number | undefined>;
    public readonly vgas!: pulumi.Output<outputs.proxmox.QemuVMVga[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: QemuVMArgs | QemuVMState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ipconfig10"] = state ? state.ipconfig10 : undefined;
            resourceInputs["ipconfig11"] = state ? state.ipconfig11 : undefined;
            resourceInputs["ipconfig12"] = state ? state.ipconfig12 : undefined;
            resourceInputs["ipconfig13"] = state ? state.ipconfig13 : undefined;
            resourceInputs["ipconfig14"] = state ? state.ipconfig14 : undefined;
            resourceInputs["ipconfig15"] = state ? state.ipconfig15 : undefined;
            ...
            resourceInputs["ipconfig6"] = state ? state.ipconfig6 : undefined;
            resourceInputs["ipconfig7"] = state ? state.ipconfig7 : undefined;
            resourceInputs["ipconfig8"] = state ? state.ipconfig8 : undefined;
            resourceInputs["ipconfig9"] = state ? state.ipconfig9 : undefined;
            ...
            resourceInputs["pxe"] = state ? state.pxe : undefined;
            ...
            resourceInputs["ipconfig10"] = args ? args.ipconfig10 : undefined;
            resourceInputs["ipconfig11"] = args ? args.ipconfig11 : undefined;
            resourceInputs["ipconfig12"] = args ? args.ipconfig12 : undefined;
            resourceInputs["ipconfig13"] = args ? args.ipconfig13 : undefined;
            resourceInputs["ipconfig14"] = args ? args.ipconfig14 : undefined;
            resourceInputs["ipconfig15"] = args ? args.ipconfig15 : undefined;
            ...
            resourceInputs["ipconfig6"] = args ? args.ipconfig6 : undefined;
            resourceInputs["ipconfig7"] = args ? args.ipconfig7 : undefined;
            resourceInputs["ipconfig8"] = args ? args.ipconfig8 : undefined;
            resourceInputs["ipconfig9"] = args ? args.ipconfig9 : undefined;
            ...
            resourceInputs["pxe"] = args ? args.pxe : undefined;
...
export interface QemuVMState {
    ...
    disks?: pulumi.Input<pulumi.Input<inputs.proxmox.QemuVMDisk>[]>;
    ...
    hostpcis?: pulumi.Input<pulumi.Input<inputs.proxmox.QemuVMHostpci>[]>;
    ...
    networks?: pulumi.Input<pulumi.Input<inputs.proxmox.QemuVMNetwork>[]>;
    /**
     * @deprecated Use `network` instead
     */
    ...
    serials?: pulumi.Input<pulumi.Input<inputs.proxmox.QemuVMSerial>[]>;
     ...
     * Record unused disks in proxmox. This is intended to be read-only for now.
     */
    unusedDisks?: pulumi.Input<pulumi.Input<inputs.proxmox.QemuVMUnusedDisk>[]>;
    usbs?: pulumi.Input<pulumi.Input<inputs.proxmox.QemuVMUsb>[]>;
    vcpus?: pulumi.Input<number>;
    vgas?: pulumi.Input<pulumi.Input<inputs.proxmox.QemuVMVga>[]>;
    /**
     * @deprecated Use `network.tag` instead
     */
