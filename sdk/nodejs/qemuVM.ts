...
export class QemuVM extends pulumi.CustomResource {
    ...
    public readonly hostpcis!: pulumi.Output<outputs.QemuVMHostpci[] | undefined>;
    ...
    public readonly usbs!: pulumi.Output<outputs.QemuVMUsb[] | undefined>;
...
export interface QemuVMState {
    ...
    hostpcis?: pulumi.Input<pulumi.Input<inputs.QemuVMHostpci>[]>;
    ...
    usbs?: pulumi.Input<pulumi.Input<inputs.QemuVMUsb>[]>;
