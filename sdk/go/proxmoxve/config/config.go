...
func GetPmDebug(ctx *pulumi.Context) bool {
	return config.GetBool(ctx, "proxmoxve:pmDebug")
}

// Set custom http headers e.g. Key,Value,Key1,Value1
func GetPmHttpHeaders(ctx *pulumi.Context) string {
	return config.Get(ctx, "proxmoxve:pmHttpHeaders")
}
...
func GetPmProxyServer(ctx *pulumi.Context) string {
	return config.Get(ctx, "proxmoxve:pmProxyServer")
}
