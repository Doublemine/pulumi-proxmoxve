...
func NewLXCDisk(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("proxmoxve:proxmox/lXCDisk:LXCDisk", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLXCDisk(ctx *pulumi.Context,
	...
	var resource LXCDisk
	err := ctx.ReadResource("proxmoxve:proxmox/lXCDisk:LXCDisk", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o LXCDiskOutput) Acl() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.BoolPtrOutput { return v.Acl }).(pulumi.BoolPtrOutput)
}

func (o LXCDiskOutput) Backup() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.BoolPtrOutput { return v.Backup }).(pulumi.BoolPtrOutput)
}

func (o LXCDiskOutput) Container() pulumi.StringOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.StringOutput { return v.Container }).(pulumi.StringOutput)
}

func (o LXCDiskOutput) Mountoptions() LXCDiskMountoptionsPtrOutput {
	return o.ApplyT(func(v *LXCDisk) LXCDiskMountoptionsPtrOutput { return v.Mountoptions }).(LXCDiskMountoptionsPtrOutput)
}

func (o LXCDiskOutput) Mp() pulumi.StringOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.StringOutput { return v.Mp }).(pulumi.StringOutput)
}

func (o LXCDiskOutput) Quota() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.BoolPtrOutput { return v.Quota }).(pulumi.BoolPtrOutput)
}

func (o LXCDiskOutput) Replicate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.BoolPtrOutput { return v.Replicate }).(pulumi.BoolPtrOutput)
}

func (o LXCDiskOutput) Shared() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.BoolPtrOutput { return v.Shared }).(pulumi.BoolPtrOutput)
}

func (o LXCDiskOutput) Size() pulumi.StringOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.StringOutput { return v.Size }).(pulumi.StringOutput)
}

func (o LXCDiskOutput) Slot() pulumi.IntOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.IntOutput { return v.Slot }).(pulumi.IntOutput)
}

func (o LXCDiskOutput) Storage() pulumi.StringOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.StringOutput { return v.Storage }).(pulumi.StringOutput)
}

func (o LXCDiskOutput) Volume() pulumi.StringOutput {
	return o.ApplyT(func(v *LXCDisk) pulumi.StringOutput { return v.Volume }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*LXCDiskInput)(nil)).Elem(), &LXCDisk{})
	pulumi.RegisterInputType(reflect.TypeOf((*LXCDiskArrayInput)(nil)).Elem(), LXCDiskArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*LXCDiskMapInput)(nil)).Elem(), LXCDiskMap{})
